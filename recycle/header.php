            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./recycling-centers.php">
                                <i class="ni ni-building text-dark"></i>
                                <span class="nav-link-text">Recycling Centers</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ml-2 d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold"><?php echo $_SESSION['f_name'] . ' ' . $_SESSION['l_name'] ; ?></span>
                                    </div>
                                </div>
                            </a>
