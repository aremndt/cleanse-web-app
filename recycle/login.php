                            ...
                            <form method="post">
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input class="form-control" name="email" placeholder="Email" type="email" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" name="submit" class="btn btn-success btn-block my-4">Sign in</button>
                                </div>
                                <div class="form-row">
